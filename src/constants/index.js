...
export const ABOUT_TEXT = `ผมเป็นนักพัฒนา Web Application ที่หลงใหลในการสร้างแอปพลิเคชันเว็บ ด้วยการฝึกฝนทักษะและเทคโนโลยี Front-End เช่น React และ Next.js รวมถึงเทคโนโลยี back-end เช่น Node.js, MySQL และ MongoDB เพื่อมุ่งไปสู่เป้าหมายคือการเป็น Full Stack developer`;
